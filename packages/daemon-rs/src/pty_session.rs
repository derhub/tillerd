...
mod tests {
    ...
    fn term_status_working_while_output_flows() {
        ...
        assert_eq!(derive_term_status(false, Some(100), 100), TermStatus::Working);
        assert_eq!(derive_term_status(false, Some(200), 100), TermStatus::Working);
    ...
    fn term_status_working_when_quiet_subjob_holds_foreground() {
        ...
        assert_eq!(derive_term_status(true, Some(200), 100), TermStatus::Working);
    }
