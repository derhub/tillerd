...
const SIGNAL_TABLE: Record<string, { meaning: string; category: SignalCategory }> = {
  SIGHUP: {
    meaning: "Controlling terminal closed or process leader exited",
    category: "graceful-termination",
  },
  SIGINT: { meaning: "Interrupt from keyboard (Ctrl+C)", category: "graceful-termination" },
  SIGQUIT: {
    meaning: "Quit from keyboard (Ctrl+\\) with possible core dump",
    category: "graceful-termination",
  },
...
export function signalCategoryToQualifier(
  category: SignalCategory,
