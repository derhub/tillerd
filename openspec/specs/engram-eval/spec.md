...
Defines how retrieval quality is measured: a committed labeled dataset, deterministic information-retrieval metrics computed without a language-model call, per-category and cost reporting, and reproducible comparison across retrieval configurations.
