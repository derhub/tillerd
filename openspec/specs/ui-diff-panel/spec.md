...
Defines the UI diff panel that displays the changes produced in a session's working directory, fetched on session completion and rendered with syntax-highlighted, collapsible file diffs.
