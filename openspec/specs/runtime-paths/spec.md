...
Centralize runtime directory and service binary resolution across the workspace to eliminate duplication and provide a single source of truth for path layout and environment-variable governance.
