...
Defines per-session output flow control between the daemon and engine clients, preventing fast producers from overwhelming slow consumers and ensuring no data loss across back-pressure events.
