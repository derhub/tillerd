...
Defines window-state persistence: the host saves the main application window's size, position, and maximized state and restores them on the next launch, independently of user settings.
