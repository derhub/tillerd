...
Defines the zero-downtime binary upgrade protocol for the daemon, allowing the running daemon to hand off live PTY sessions to a successor process without interrupting active sessions.
