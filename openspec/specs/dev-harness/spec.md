...
Defines the composition root and client-facing surfaces: `apps/server` as the server composition root (engine + adapter injection, WebSocket/HTTP exposure) and `apps/ui` as the single-page terminal client.
