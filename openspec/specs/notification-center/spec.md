...
The notification center is the app's single user-facing feedback channel. It derives
notifications from lifecycle signals (surface start / stop / error, service up / down,
