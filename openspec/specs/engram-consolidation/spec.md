...
Defines how the memory layer condenses and ages content: a model-free consolidation ladder from chunks to monthly digests, coverage tracking, lazy eviction of covered content to a never-deleted archive, and a year-sharded archive.
