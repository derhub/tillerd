...
Defines the binary frame format, protocol version negotiation handshake, and typed frame catalogue for all messages exchanged between the daemon and engine clients over the Unix domain socket.
