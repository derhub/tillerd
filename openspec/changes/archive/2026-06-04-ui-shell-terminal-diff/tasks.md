...
- [x] 14.1 `bun run dev` starts without errors (server + UI)
- [x] 14.2 Tabbar-top mode: tabs render titles; only active panel mounts
- [x] 14.3 Sidebar mode: vertical list renders; click expands correct panel
