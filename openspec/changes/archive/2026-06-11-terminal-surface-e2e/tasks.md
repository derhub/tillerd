...
- [x] 12.1 Create a session in the Unfiled project with a terminal surface; the terminal renders and streams live pseudo-terminal bytes through the orchestrator API / surface channel, not the engine (acceptance 1).
